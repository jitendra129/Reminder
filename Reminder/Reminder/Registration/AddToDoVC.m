...
- (void)viewDidLoad {
    [super viewDidLoad];
    NSString *key=[NSString stringWithFormat:@"ToDo%@",self.SelectedIndex];
    ...
    if (data.length) {
        ...
        self.lblAddReminder.text=@"UPDATE TODO";
        ...
        self.lblAddReminder.text=@"ADD TODO";
...
-(IBAction)onClickDelete:(id)sender{
    ...
    [self.delegate deleteToDoData:key];
...
- (IBAction)clickToAdd:(id)sender {
    NSInteger nextR=[ECSUserDefault getIntFromUserDefaultForKey:@"CountToDo"];
    if (self.SelectedIndex) {
        ...
        NSString *strForKey=[NSString stringWithFormat:@"ToDo%ld",(long)nextR];
        [[NSUserDefaults standardUserDefaults]setObject:data forKey:strForKey];
        [[NSUserDefaults standardUserDefaults]synchronize];
        
        
        [self.delegate UpdateToDoData:strForKey];
        ...
        [self.delegate getToDoData:object];
...
- (IBAction)clickToSetDate:(id)sender {
